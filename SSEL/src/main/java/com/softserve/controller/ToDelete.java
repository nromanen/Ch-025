...
public class ToDelete {
	...
	public static List<Log> getFakeList() {
		...
		log1.setMassage("No supported matching language for locale \"ua\". Using file:/F:/Java/Workspace2/.metadata/.plugins/org.eclipse.wst.server.core/"
		...
		log2.setMassage("Context initialization failed");
		...
		log3.setMassage("No mapping found for HTTP request with URI [/SSEL/deleteCategories] in DispatcherServlet with name 'appServlet'");
		log3.setException("");
		log4.setEventDate(new Date());
		log4.setLevel("WARN");
		log4.setLogger("org.springframework.web.context.support.XmlWebApplicationContext");
		log4.setMassage("Exception thrown from LifecycleProcessor on context close");
		...
		log5.setMassage("No supported matching language for locale \"ua\". Using file:/F:/Java/Workspace2/.metadata/.plugins/org.eclipse.wst.server.core/"
				+ "tmp0/wtpwebapps/SSEL/WEB-INF/tiles/templates_ua.xml as a non-localized resource path. see TILES-571");
		...
		log6.setMassage("Context initialization failed");
