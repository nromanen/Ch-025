...
public class AdministratorController {
	...
	@ResponseBody
	public String changeSubjectAjax (@RequestParam(value = "elementsOnPage", required = false) Integer elementsOnPage,
			RedirectAttributes redirectAttributes) {
		System.out.println("-------->"+elementsOnPage);
//		String s;
//		s = "asd " + elementsOnPage;
//		System.out.println("-------->"+s);
	...
	public String viewAllRequests(
		...
		List<Role> roles = roleService.getAllRoles();
		List<TeacherRequest> teacherRequests = teacherRequestService.getAllActiveTeacherRequests();
	...
	public String changeUserRoleToAdmin(
		...
		if (userId != null) {
			...
			user.setRole(role);
			userService.updateUser(user);
			TeacherRequest teacherRequest = teacherRequestService.getTeacherRequestByUserId(userId);
